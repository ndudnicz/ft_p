...
$(OBJ_CLIENT_DIR)/%.o: $(SRC_CLIENT_DIR)/%.c
	$(CC) $(FLAGS) -o $@ -c $< -I $(PATH_CLIENT_INCLUDES) -I libft/includes

$(SERVEUR): $(OBJ_SERVEUR)
	$(CC) -o $@ $(OBJ_SERVEUR) -L. -lft -lftasm

$(OBJ_SERVEUR_DIR)/%.o: $(SRC_SERVEUR_DIR)/%.c
	$(CC) $(FLAGS) -o $@ -c $< -I $(PATH_SERVEUR_INCLUDES) -I libft/includes
...
fclean: clean
		...
		/bin/rm -rf $(CLIENT) $(SERVEUR) libft.a libftprintf.a
